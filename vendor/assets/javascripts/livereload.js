...
livereload.run = function() {
    this.background.togglePage(document);
};

livereload.toggle = function() {
    if (!sessionStorage.livereloadEnabled) {
      sessionStorage.livereloadEnabled = true;
      this.background.enablePage(document);
    } else {
      delete sessionStorage.livereloadEnabled;
      this.background.disablePage(document);
    }
}

if (sessionStorage.livereloadEnabled) livereload.run();
