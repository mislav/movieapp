...
describe Netflix::Title do
  ...
  before(:all) do
    stub_request(:get, 'http://api-public.netflix.com/catalog/titles?start_index=0&term=mar%20adentro&max_results=5&v=1.0').
...
describe Netflix, "autocomplete" do
  ...
  before(:all) do
    stub_request(:get, 'http://api-public.netflix.com/catalog/titles/autocomplete?term=step&v=1.0').
